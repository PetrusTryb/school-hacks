// ==UserScript==
// @name         Quizziz Correct Answers Stealer
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  try to take over the world!
// @author       Anonimas420 (original concept author), improved by Piotr Trybisz
...
(() => {
    ...
    function getName(){
if (name.length<1){
name=prompt("Enter the name of another player here, he must take part in the quiz!")
}
        return name;
    }
    function main(){
    var e = function(e, t, r, n) {
        ...
        t = function(e, t) {
            ...
            function c(i) {
                return function(c) {
                    return function(i) {
                        if (r) throw new TypeError("The generator is already running.");
                        for (; a;) try {
    ...
    var r = function() {
            ...
            if (!e) throw new Error("Failed to get question list item.");
            return e
        },
        n = function(e) {
            e.style.opacity = "20%"
    ...
    e(void 0, void 0, void 0, (function() {
        ...
        return t(this, (function(a) {
            if (console.log(`%c
            \n  Thanks to Anonimas420.
            \n  https://github.com/Anonimas420/quizizz_atsakymai
            \n  Translated and improved by Piotr Trybisz as part of SchoolHacks project.
            \n  https://github.com/PetrusTryb/school-hacks
            `, "color: red;"), !(o = getName())) throw new Error("PlayerID not specified.");
            return i = function() {
                    var e = document.querySelector("body > div");
                    if (!e) throw new Error("Failed to get root object.");
                    var t = e.__vue__,
                        r = t.$store._vm.currentQuestion.id,
                        n = t.$store._vm._data.$$state.game.data.roomHash;
                    if (!r || !n) throw new Error("Failed to get questionID or roomHash.\nYou have to launch the script AFTER the game starts!");
                    var o = localStorage.getItem("previousContext");
                    if (!o) throw new Error("Failed to get previous context.");
                    return {
                        id: r,
                        roomHash: n,
                    ...
                    e(void 0, void 0, void 0, (function() {
                        ...
                        return t(this, (function(t) {
                            switch (t.label) {
                                ...
                                case 2:
                                    return e = t.sent(), console.log(e), (i = e.question.structure.answer) instanceof Array && i.length > 0 ? function(e) {
                                        var t = r(),
                                        ...
                                        return e.text
                                    })), alert(a.join(" or ")), console.log(a)) : console.log("Failed to auto-reply type.", e.question), [2]
                            }
                            var a, c, s, u, l
                        }))
                    }))
